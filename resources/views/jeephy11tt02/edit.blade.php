...
@section('content')
	...
	<div class="row">
		{!! Form::model($jeephy11tt02, ['route' => ['jeephy11tt02.update', $jeephy11tt02->id], 'method' => 'PATCH']) !!}
		<div class="col-md-8">
		...
		<div class="col-md-4">
			<div class="well">
				<dl class="dl-horizontal">
					<dt>Created At:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jeephy11tt02->created_at)) }}</dd>
				</dl>

				<dl class="dl-horizontal">
					<dt>Last Updated:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jeephy11tt02->updated_at)) }}</dd>
				</dl>
				<hr>
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('jeephy11tt02.show', 'Cancel', array($jeephy11tt02->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
