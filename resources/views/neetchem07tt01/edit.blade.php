...
@section('content')
	...
	<div class="row">
		{!! Form::model($neetchem07tt01, ['route' => ['neetchem07tt01.update', $neetchem07tt01->id], 'method' => 'PATCH']) !!}
		<div class="col-md-8">
		...
		<div class="col-md-4">
			<div class="well">
				<dl class="dl-horizontal">
					<dt>Created At:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($neetchem07tt01->created_at)) }}</dd>
				</dl>

				<dl class="dl-horizontal">
					<dt>Last Updated:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($neetchem07tt01->updated_at)) }}</dd>
				</dl>
				<hr>
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('neetchem07tt01.show', 'Cancel', array($neetchem07tt01->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
