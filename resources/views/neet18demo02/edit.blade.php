...
@section('content')
	...
	<div class="row">
		{!! Form::model($neet18demo02, ['route' => ['neet18demo02.update', $neet18demo02->id], 'method' => 'PATCH']) !!}
		<div class="col-md-8">
			...
			{{ Form::textarea('question_data', null, array('class' => 'form-control')) }}
				...
				{{ Form::select('subject',['physics'=>'PHYSICS','chemistry'=>'CHEMISTRY','biology'=>'BIOLOGY'] ,null, ['class' => 'form-control'] ) }}
		...
		<div class="col-md-4">
			<div class="well">
				<dl class="dl-horizontal">
					<dt>Created At:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($neet18demo02->created_at)) }}</dd>
				</dl>

				<dl class="dl-horizontal">
					<dt>Last Updated:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($neet18demo02->updated_at)) }}</dd>
				</dl>
				<hr>
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('neet18demo02.show', 'Cancel', array($neet18demo02->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
