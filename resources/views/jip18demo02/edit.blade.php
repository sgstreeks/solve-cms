...
@section('content')
	...
	<div class="row">
		{!! Form::model($jip18demo02, ['route' => ['jip18demo02.update', $jip18demo02->id], 'method' => 'PATCH']) !!}
		<div class="col-md-8">
			...
			{{ Form::textarea('question_data', null, array('class' => 'form-control')) }}
				...
				{{ Form::select('subject',['physics'=>'PHYSICS','chemistry'=>'CHEMISTRY','biology'=>'BIOLOGY','english'=>'ENGLISH','logical reasoning'=>'LOGICAL REASONING'] ,null, ['class' => 'form-control'] ) }}
		...
		<div class="col-md-4">
			<div class="well">
				<dl class="dl-horizontal">
					<dt>Created At:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jip18demo02->created_at)) }}</dd>
				</dl>

				<dl class="dl-horizontal">
					<dt>Last Updated:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jip18demo02->updated_at)) }}</dd>
				</dl>
				<hr>
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('jip18demo02.show', 'Cancel', array($jip18demo02->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
