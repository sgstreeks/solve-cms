...
@section('content')
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			{!! Form::open(array('route' => 'jeephy01tt01.store')) !!}
			...
			{{ Form::textarea('question_data', null, array('class' => 'form-control')) }}
				...
				{{ Form::text('option1', null, array('class' => 'form-control')) }}

				{{ Form::label('option2', 'option2:') }}
				{{ Form::text('option2', null, array('class' => 'form-control')) }}

				{{ Form::label('option3', 'option3:') }}
				{{ Form::text('option3', null, array('class' => 'form-control')) }}

				{{ Form::label('option4', 'option4:') }}
                {{ Form::text('option4', null, array('class' => 'form-control')) }}
