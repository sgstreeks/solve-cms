...
@section('content')
	...
	<div class="row">
		{!! Form::model($jeemat07t02, ['route' => ['jeemat07t02.update', $jeemat07t02->id], 'method' => 'PATCH']) !!}
		<div class="col-md-8">
		...
		<div class="col-md-4">
			<div class="well">
				<dl class="dl-horizontal">
					<dt>Created At:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jeemat07t02->created_at)) }}</dd>
				</dl>

				<dl class="dl-horizontal">
					<dt>Last Updated:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jeemat07t02->updated_at)) }}</dd>
				</dl>
				<hr>
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('jeemat07t02.show', 'Cancel', array($jeemat07t02->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
