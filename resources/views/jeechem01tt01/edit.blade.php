...
@section('content')
	...
	<div class="row">
		{!! Form::model($jeechem01tt01, ['route' => ['jeechem01tt01.update', $jeechem01tt01->id], 'method' => 'PATCH']) !!}
		<div class="col-md-8">
		...
		<div class="col-md-4">
			<div class="well">
				<dl class="dl-horizontal">
					<dt>Created At:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jeechem01tt01->created_at)) }}</dd>
				</dl>

				<dl class="dl-horizontal">
					<dt>Last Updated:</dt>
					<dd>{{ date('M j, Y h:ia', strtotime($jeechem01tt01->updated_at)) }}</dd>
				</dl>
				<hr>
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('jeechem01tt01.show', 'Cancel', array($jeechem01tt01->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
